  ...
  const careerExperiences = [
    {
      ...
      type: "Part-time",
      mode: "Onsite",
      logo: "/src/public/himatekkom-logo.png",
      responsibilities: [
    ...
    },
    {
      ...
      type: "Part-time",
      mode: "Onsite",
      logo: "/src/public/shopee-logo.png",
      responsibilities: [
    ...
    },
    {
      ...
      type: "Internship",
      mode: "Onsite",
      logo: "/src/public/diskominfo-logo.png",
      responsibilities: [
      ...
      <div className="mb-10">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex flex-wrap gap-1 mt-4">
            <a
              href="/src/public/As'ad Mahmud Akram_Portofolio.pdf"
              download
            ...
            <a
              href="/src/public/As'ad Mahmud Akram_CV.pdf"
              download
              className="bg-gray-800 text-white text-xs md:text-sm px-2 md:px-3 py-1 rounded hover:bg-gray-700 transition flex items-center gap-1"
            >
              <Download size={12} />
